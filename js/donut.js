        ...
        *2/150;}_f+=0.01;_g+=0;_h+            =0.01;_b.fillStyle='rgba(0,
        0,0,0)';_b.clearRect(0,0,500,500);_b.fillRect(0,0,500,500);_j.fo
        rEach((a,y)=>a.forEach((b,x)=>{_b.font=\`\$\{_d\}px Consolas\`;
        _b.fillStyle='black';_b.fillText(" .,-~:;!=*#$@"[E(b*12)],x*_e
        ,y*_d);_i[y][x]=0;_j[y][x]=0;}));};setInterval(draw,50/3);`.
          replaceAll("\n","").replaceAll("  ",""));/*--------------
           ------------------------------------------------- ---
             --------------------------------------------------
              ------------------------------------------------
